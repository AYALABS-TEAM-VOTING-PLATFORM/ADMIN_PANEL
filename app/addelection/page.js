...
// const [loading, setLoading] = useState(false)
  ...
  return (
    <div className="flex justify-center items-center pl-20 pr-[20px] mt-[20px] sm:ml-[0px] md:ml-[0px] sm:pl-7 md:pl-7">
      ...
      <div className="bg-white rounded-md py-5 w-full px-5 sm:w-[100%] md:w-[100%]  pt-10">
            ...
            <form className="">
                  {/* first input */}
                <div className="flex gap-10 mb-10 sm:flex-col md:flex-col">
                  ...
                  <input type="text" placeholder="Enter" className="text-[#121212] px-1 py-2 pr-48 border-2"/>
                   ...
                   {/* second input */}
                   <div className="flex gap-10 sm:flex-col mb-10 md:flex-col">
                  ...
                  <input type="text" placeholder="Enter" className=" px-1 py-2 text-[#121212] pr-48 border-2"/>
                   ...
                   {/* third input */}
                   <div className="flex gap-10 sm:flex-col mb-3 md:flex-col">
                  <input type="text" placeholder="Enter" className=" px-1 py-2 text-[#121212] pr-48 border-2"/>
                  <input type="text" placeholder="Enter" className=" px-1 py-2 text-[#121212] pr-48 border-2"/>
                </div>
