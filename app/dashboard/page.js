...
export default function Dashboard() {
  ...
  return (
    <div className="lg:ml-20 pl-20 pr-[20px] mt-[20px] sm:ml-[0px] md:ml-[0px] sm:pl-7 md:pl-7">
      {/* second */}
      <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-5 mb-8 lg:gap-8 sm:flex-col md:flex-col sm:flex md:flex">
        <div className="bg-white rounded-md py-5 px-5 sm:w-full md:w-full lg:w-[33%]">
